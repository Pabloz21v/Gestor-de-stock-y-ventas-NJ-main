                                ...
                                <tbody>
                                    <tr v-for="user in users.data" :key="user.id">
                                        ...
                                        <td class="border px-4 py-2 hidden sm:table-cell">
                                            <p class="mt-1 truncate text-xs leading-5 text-gray-500">{{ user.apellido }}
                                            </p>
                                        ...
                                        <td class="border px-4 py-2 hidden sm:table-cell">
                                            <p class="mt-1 truncate text-xs leading-5 text-gray-500">{{ user.domicilio }}
                                            </p>
                                        ...
                                        <td class="border px-4 py-2 hidden sm:table-cell">
                                            <p class="mt-1 truncate text-xs leading-5 text-gray-500 max-w-12">
                                                {{ user.comentarios }}</p>
                                        </td>
                ...
                <div class="flex justify-between mt-2">
                    <div>
                        <Link v-if="users.current_page > 1" :href="users.prev_page_url"
                            class="bg-teal-200 rounded-lg p-1">
                        PREVIOUS
                        </Link>
                    </div>
                    <div>
            ...
            <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                ...
                <div
                    ...
                    <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                        ...
                        <button @click="deleteUser(modalDataID)" type="button"
