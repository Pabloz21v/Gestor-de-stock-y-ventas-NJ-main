			...
			<div class="relative w-full max-w-2xl px-6 lg:max-w-7xl"> -->
                ...
                <!-- <div class="grid grid-cols-2 items-center gap-2 py-10 lg:grid-cols-3">
					...
					<nav v-if="canLogin" class="-mx-3 flex flex-1 justify-end">
						...
						>
							Dashboard / page inicial
						</Link>

						<template v-else>
							<Link
							
							<Link :href="route('role.index')"> Cancelar</Link>
								:href="route('login')"
								class="rounded-md px-3 py-2 text-black ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white"
							>
								Log in
                    ...
                    <div class="max-w-3xl mx-auto">
                        ...
                        <div class="p-6">
                            ...
                            >
                                <div>
                                    <img
                                        src="../../../storage/app/public/images/Carpano.png"
                                        alt=""
                                        class="max-w-36"
                                    />
                                </div>
                                <div>
                                    <img
                                        src="../../../storage/app/public/images/FB02.png"
                                        alt=""
                                        class="max-w"
                                    />
                                </div>
                                <div>
                                    <img
                                        src="../../../storage/app/public/images/LOGO-VODKA-NEGRO.png"
                                        alt=""
                                        class="max-w-36"
                                    />
                                </div>
