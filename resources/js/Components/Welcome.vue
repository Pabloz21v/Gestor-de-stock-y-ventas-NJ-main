                    ...
                    <div class="max-w-3xl mx-auto">
                        ...
                        <div class="p-6">
                            <div class="flex justify-center">
                                <div class="mb-4">
                                    <img src="../../../storage/app/public/images/viralstore.jpg" alt="Logo Restaurant"
                                        class="xl:max-w-80 sm:max-w-64" />
                                </div>
                            </div>

                            <!-- Imágenes inferiores -->
                            <!-- <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 justify-items-center items-center mx-5">
                                <div>
                                    <img src="../../../storage/app/public/images/Carpano.png" alt="" class="max-w-36" />
                                </div>
                                <div>
                                    <img src="../../../storage/app/public/images/FB02.png" alt="" class="max-w" />
                                </div>
                                <div>
                                    <img src="../../../storage/app/public/images/LOGO-VODKA-NEGRO.png" alt=""
                                        class="max-w-36" />
                                </div>
                            </div> -->
                        </div>
                        ...
                        <div class="container mx-auto px-8">
                            <div class="flex flex-col md:flex-row justify-around items-center">
                                ...
                                <div class="mb-6 md:mb-0">
                                    ...
                                    <p>
                                        Horario de atención: Lun - Vie, 9:00 -
                                        18:00
                                    </p>
                                </div>
