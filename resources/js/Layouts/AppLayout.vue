        ...
        <div class="min-h-screen bg-gray-100">
            <nav class="bg-white border-b border-gray-100">
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                <NavLink :href="route('ofertas')" :active="route().current('ofertas')">
                                    Ofertas
                                </NavLink>
                            </div>
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex" v-if="
                            ...
                            ">
                                <NavLink :href="route('history.index')" :active="route().current('history')">
                                    Historial
                                </NavLink>
                            </div>
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex" v-if="
                            ...
                            <div class="ms-3 relative">
                                <Dropdown align="right" width="48">
                                    ...
                                    <template #content>
                                        ...
                                        <div
                                            class="grid grid-cols-1 gap-2 place-items-center divide-y divide-slate-200">
                                            <div class="font-medium text-base text-gray-800 pt-2">
                                                {{ $page.props.auth.user.name }}
                                            </div>
                                            <div class="font-medium text-sm text-gray-500 py-1">
                                                {{
                ...
                <div :class="{
                    ...
                    ">
                        <ResponsiveNavLink :href="route('history.index')" :active="route().current('history.*')">
                            Historial
                        </ResponsiveNavLink>
                    </div>
                    <div class="pt-2 pb-3 space-y-1" v-if="
                    ...
                    ">
                        <ResponsiveNavLink :href="route('role.index')" :active="route().current('role.*')">
                            Cuentas
                        </ResponsiveNavLink>
                    </div>
